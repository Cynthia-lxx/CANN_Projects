...
CASES = [
    ...
    # ---- judge-domain torture (cid 220+): 官方域 K>=32 且 K%8==0, 非方阵 /
    # 非 8 倍数尾 N/M、tx 组合、全负、M/N 一维、长 K。gen 脚本对 x1/x2 一律按
    # storage 布局落盘 + 逻辑 shape 下发，与判题注入一致。----
    (220, 2, 3, 5, 32, "bfloat16", False, False, "random",
     {"seed": 4001, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "odd_tiny_bf16", "奇小 shape ff bf16 (N=5 尾)"),
    (221, 1, 5, 7, 40, "float16", True, False, "random",
     {"seed": 4002, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "odd_x1tx_fp16", "奇 shape 仅 x1 转置 fp16 (K=40)"),
    (222, 3, 7, 3, 32, "bfloat16", False, True, "random",
     {"seed": 4003, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "odd_x2tx_bf16", "奇 shape 仅 x2 转置 bf16 (N=3 尾)"),
    (223, 2, 9, 11, 48, "bfloat16", True, True, "random",
     {"seed": 4004, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "odd_both_bf16", "奇 shape 双转置 bf16"),
    (224, 1, 64, 65, 64, "float16", False, False, "random",
     {"seed": 4005, "x1_domain": [0.5, 2.0], "x2_domain": [-2.0, -0.5]},
     "fullneg_n65_fp16", "N=65 尾 + 全负行 fp16"),
    (225, 1, 17, 33, 64, "bfloat16", True, True, "random",
     {"seed": 4006, "x1_domain": [0.5, 2.0], "x2_domain": [-2.0, -0.5]},
     "fullneg_tt_bf16", "双转置 + 全负 bf16 (尾 M/N)"),
    (226, 4, 1, 8, 32, "float16", True, False, "random",
     {"seed": 4007, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "m1_x1tx_fp16", "M=1 单行 x1 转置 fp16"),
    (227, 2, 8, 1, 64, "bfloat16", False, True, "random",
     {"seed": 4008, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "n1_x2tx_bf16", "N=1 单元素 max x2 转置 bf16"),
    (228, 1, 129, 8, 72, "float16", False, False, "random",
     {"seed": 4009, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "m129_n8_fp16", "M>128 非对齐 x N<8 倍尾 fp16"),
    (229, 1, 8, 129, 40, "bfloat16", True, False, "random",
     {"seed": 4010, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "n129_bf16", "N>128 尾 x M=8 bf16"),
    (230, 16, 5, 6, 32, "float16", True, True, "random",
     {"seed": 4011, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "b16_odd_tt", "B=16 奇小 shape 双转置 fp16"),
    (231, 1, 257, 3, 32, "bfloat16", False, True, "random",
     {"seed": 4012, "x1_domain": [-2.0, 2.0], "x2_domain": [-2.0, 2.0]},
     "m257_n3_bf16", "M=257 行方向 x N=3 尾 bf16"),
    (232, 1, 4, 4, 8192, "bfloat16", False, False, "random",
     {"seed": 4013, "x1_domain": [-1.0, 1.0], "x2_domain": [-1.0, 1.0]},
     "k8192_bf16_tiny", "K=8192 长点积 bf16"),
    (233, 2, 16, 17, 128, "bfloat16", True, False, "random",
     {"seed": 4014, "x1_domain": [0.5, 2.0], "x2_domain": [-2.0, -0.5]},
     "fullneg_x1tx_bf16", "仅 x1 转置 + 全负 bf16"),
]
